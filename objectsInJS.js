...
function greet(name , favGame)
{
  this.name = name;
  this.favGame=favGame;
  console.log(`${this.name} favourite game is `)
}
let a = new greet("karan","badminton");

greet.prototype.nword = function(){
  console.log("you cant say that ")
}
